...
var play = function (userChoice) {
    ...
    if (wins > 99 || loses > 99) {
        ...
        document.getElementById("ties").style.fontSize = "44";
    }
    if (wins > 999) {
        alert(
            "You reached the max score of 999. <br />Congratulations, you have no life."
        );
    }
    if (loses > 999) {
        alert(
            "Your opponent reached the max score of 999. <br />We're sorry, you have no life."
        );
    }
};
